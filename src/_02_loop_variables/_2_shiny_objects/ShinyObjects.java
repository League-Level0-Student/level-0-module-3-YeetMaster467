...
public class ShinyObjects {
	...
	void manyShinyObjects() {
		...
		String response = JOptionPane.showInputDialog("How many shiny objects do you want?");
		int amountOfShinyObjects = Integer.parseInt(response);
		// 3. Play the sound that many times
		for(int i=0; i<amountOfShinyObjects; i++) {
			playMisterZee();
		}
